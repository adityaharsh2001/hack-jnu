    ...
    <div className="bg-white  rounded-md p-8  shadow-md w-96 text-center">
      ...
      <div className="mb-4">
...

        {
          ...
          >
            Signing in ... <svg aria-hidden="true" class="inline w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
