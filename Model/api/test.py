...
response = model.predict(
    """Case Type(string): Categorise cases based on their legal nature (e.g., civil, criminal, family, commercial, etc)
...
input: \"t\": \"M/S.Padmavati Enterprises vs The Deputy Commissioner Of ... on 22 December, 2021\",
        \"s\": \"Madras High Court\",
        \"id\": 213626,
