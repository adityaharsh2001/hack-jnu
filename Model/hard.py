...
if __name__ == "__main__":
  ...
  for index, row in enumerate(data):
     prompt = f"""Assign a priority score from 1 to 10 to the cases below. 1 being the highest priority and 10 being the lowest priority. Predict the pririty considering all the keys in the object provided
     input:
  \"case_id\": 217806,
  \"Case Type\": \"Criminal\",
  \"Case Complexity\": 3,
...
output:
     ...
     # add a field priority to the json object
     data[index]["priority"] = res
    #  print(data[index])
